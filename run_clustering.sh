...
#python run_experiment.py --pca --dataset2 --verbose --threads -1 > pca-dataset2-clustering.log 2>&1
python run_experiment.py --pca --dataset2 --dim 175 --skiprerun --verbose --threads -1 > pca-dataset2-clustering_v2.log 2>&1
