...
import experiments2
from experiments2 import plotting
...
if __name__ == '__main__':
    ...
    dataset2_details = {
            ...
            'best_nn_params': {'NN__activation': ['relu'], 'NN__learning_rate': ["adaptive"],
                               'NN__hidden_layer_sizes': [800]}
    }
    ...
    for ds in datasets:
        ...
        data.scale_standard()
        experiment_details.append(experiments2.ExperimentDetails(
    ...
    if args.all or args.benchmark or args.ica or args.pca or args.lda or args.svd or args.rf or args.rp:
        ...
        if args.benchmark or args.all:
            run_experiment(experiment_details, experiments2.BenchmarkExperiment, 'Benchmark', args.dim, args.skiprerun,
                           verbose, timings)
        if args.ica or args.all:
            run_experiment(experiment_details, experiments2.ICAExperiment, 'ICA', args.dim, args.skiprerun,
                           verbose, timings)
        if args.pca or args.all:
            run_experiment(experiment_details, experiments2.PCAExperiment, 'PCA', args.dim, args.skiprerun,
                           verbose, timings)
        if args.rf or args.all:
            run_experiment(experiment_details, experiments2.RFExperiment, 'RF', args.dim, args.skiprerun,
                           verbose, timings)
        if args.rp or args.all:
            run_experiment(experiment_details, experiments2.RPExperiment, 'RP', args.dim, args.skiprerun,
                           verbose, timings)
